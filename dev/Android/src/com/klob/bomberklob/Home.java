...
public class Home extends Activity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		this.solo = (Button)findViewById(R.id.boutonSolo);        
        ...
        this.accounts.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, this.model.getSystem().getDatabase().accounts()));
