	...
	\subsection{Options}
		...
		\subsubsection{Description des zones}
			...
			\begin{tabular}{|c|c|c|c|c|} \hline
				...
				4 & Liste déroulante & Permet de choisir la langue voulu pour le jeu & Perte du focus & RG8-02 \\\hline 
				5 & Bouton & Ouvre la page de gestion de profil &
				Cliqué & RG8-03 \\\hline 6 & Bouton & Permet de revenir à l'accueil principal & Cliqué & RG8-04 \\\hline
			\end{tabular}
...
\newpage
	...
	\subsection{Gestion du profil}
		...
		\subsubsection{Description des zones}
			...
			\begin{tabular}{|c|c|c|c|c|} \hline
				...
				6 & Check box & Permet la connexion automatique & Chargement de la page & RG9-06 \\
				  &           & lors des parties multi-joueurs  & Cliquée               & RG9-07 \\\hline
			\end{tabular}
		...
		\subsubsection{Description des règles}
			...
			\underline{RG9-02 :}
				\begin{quote}
					Modifier la couleur dans la classe utilisateur.
					Modifier la couleur dans
				\end{quote}
