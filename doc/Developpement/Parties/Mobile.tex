...
\subsection{Editeur de carte}
	...
	\subsubsection{Général}
		\paragraph{Moteur de rendu\\}
			...
			Grâce à ces deux matrices, les joueurs pourront à tout moment modifier les éléments de la première matrice ou de la deuxième.
...
\subsection{Jeu}
	...
	\subsubsection{Moteurs}
		...
		pour s'occuper des interactions joueurs et objets. En enfin un dernier gérant
		...
		\paragraph{Moteur de rendu\\}
			...
			doit s'occuper des interactions joueurs et objets \footnote{
			...
			trouve en dessous.
			Nous allons donc stocker ce bloc dans une hashmap dont les clefs sont les
			...
			tel est le cas, alors nous le stockons dans la hashmap comme un bloc
		...
		\paragraph{Moteur physique\\}
			...
			\subparagraph{Deplacements\\}
				...
				Le principe des collisions sous IOS a été réfléchi de manière a ce que les
				...
				Donc pour remédier à ce problème nous avons décidé d'établir un système de marge sous IOS.
