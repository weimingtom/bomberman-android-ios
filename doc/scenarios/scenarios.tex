...
\newpage
	...
	\subsection{Chargement de l'application}
		...
		\input{./img/0_Chargement_de_l_application}
...
\newpage
	...
	\subsection{Création d'un compte multi-joueurs}
		...
		\input{./img/4_Creation_compte_multi_joueurs}
...
\newpage
	...
	\subsection{Accueil multi-joueurs}
		...
		\input{./img/5_Accueil_multi_joueur}
