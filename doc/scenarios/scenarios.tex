				...
				\begin{quote}
					...
					Si aucune erreur n'a été détectée alors
						\begin{quote}
							...
							Sinon
							\begin{quote}
								Afficher l'accueil multi-joueurs%
								\footnote[2]{
									\hyperlink{Accueil multi-joueurs}{Accueil multi-joueurs}
									\og voir section \ref{Accueil multi-joueurs}, page \pageref{Accueil multi-joueurs}.\fg
								}.\\
								Si la check-box de connexion automatique (7) ou que la check-box de mémorisation du mot de passe (8) est cochée alors 
								\begin{quote}
